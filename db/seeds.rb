...
10.times do
  Patient.create( name: Faker::Name.first_name, last_name: Faker::Name.last_name, run: Faker::ChileRut.unique.full_rut, birth_date: Faker::Date.between(from: 100.years.ago, to: 12.years.ago) ) 
end
